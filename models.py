...
class StyleTTS2:
    ...
    def keys(self):
        """
        Return a dynamic view of component names, mirroring dict.keys().
        """
        return self._model.keys()

    def items(self):
        """
        Return a dynamic view of (name, module) pairs, like dict.items().
        """
        return self._model.items()

    def values(self):
        """
        Return a dynamic view of modules, like dict.values().
        """
